...
namespace TechDaily.Infrastructure.Migrations
{
    ...
    partial class TechDailyDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechDaily.Domain.Entities.EmailOtp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PendingLocale")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");
            ...
            modelBuilder.Entity("TechDaily.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TechDaily.Domain.Entities.UserBookPacer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CurrentChunkOrder")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);

                    b.Property<int>("DailyPaceChunks")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
                    ...
                    b.HasIndex("UserId", "DocumentBookId")
                        .IsUnique();

                    b.HasIndex("UserId", "IsActive");

                    b.ToTable("UserBookPacers");
                });
            ...
            modelBuilder.Entity("TechDaily.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("TechDaily.Domain.Entities.RefreshToken", "ReplacedByToken")
                        .WithMany()
