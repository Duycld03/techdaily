...
<template>
  <div class="pointer-events-auto select-none transition-all duration-300">
    ...
    >
      <HelpCircle class="w-4 h-4 text-brand-500 shrink-0" :stroke-width="1.5" />
      <span class="whitespace-nowrap shrink-0">{{ $t('graph.legend.title') }}</span>
      <ChevronUp class="w-3.5 h-3.5 text-slate-400 shrink-0" :stroke-width="1.5" />
    </button>
    ...
    >
      ...
      <div class="flex items-center justify-between pb-1.5 border-b border-slate-100 dark:border-white/[0.08]">
        <div class="flex items-center gap-1.5 font-bold text-slate-900 dark:text-white tracking-wide">
          <Layers class="w-3.5 h-3.5 text-brand-500 shrink-0" :stroke-width="1.5" />
        ...
        <button
          ...
          @click="toggleCollapse"
        >
          <ChevronDown class="w-3.5 h-3.5 shrink-0" :stroke-width="1.5" />
        </button>
      </div>
      ...
      <div class="space-y-1.5 pt-1.5 border-t border-slate-100 dark:border-white/[0.06]">
        <div class="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">
          <Sparkles class="w-3 h-3 text-amber-500 shrink-0" :stroke-width="1.5" />
