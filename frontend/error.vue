...
<template>
  <div class="min-h-dvh flex items-center justify-center bg-slate-50 dark:bg-canvas text-slate-900 dark:text-slate-100 p-4 transition-colors duration-200">
    <div class="max-w-md w-full text-center space-y-6 glass-panel rounded-3xl p-6 sm:p-8 shadow-2xl">
      ...
      >
        <component :is="is404 ? Compass : AlertTriangle" class="w-4 h-4 shrink-0" :stroke-width="1.5" />
      ...
      <div class="flex justify-center">
        ...
        >
          <component :is="is404 ? Compass : AlertTriangle" class="w-10 h-10 sm:w-12 sm:h-12" :stroke-width="1.5" />
        </div>
      </div>
      ...
      <div class="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
        <button
          ...
          @click="handleHome"
        >
          <ArrowLeft class="w-4 h-4 shrink-0" :stroke-width="1.5" />
        ...
        <button
          ...
          @click="handleRetry"
        >
          <RotateCcw class="w-4 h-4 shrink-0" :stroke-width="1.5" />
