    ...
    <div class="flex-1 flex overflow-hidden relative">
      ...
      >
        ...
        <div v-else-if="currentChunk" class="w-full max-w-3xl space-y-8 sm:space-y-10">
          ...
          <div class="pt-6 mt-8 sm:mt-12 border-t border-slate-200 dark:border-slate-800/80 space-y-3">
            <!-- Progress Meta Bar -->
            <div class="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400 px-1">
              ...
              <div class="flex items-center gap-2">
                <span>{{ $t('reader.done', { count: activeChunkIndex + 1, total: totalChunks }) }}</span>
                <span class="text-slate-300 dark:text-slate-700">•</span>
                <span class="font-bold text-slate-700 dark:text-slate-300">{{ progressPercentage }}%</span>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              ...
              >
                <div class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors">
                  <ChevronLeft class="w-3.5 h-3.5 transition-transform group-hover:-translate-x-1 shrink-0" />
                  <span class="whitespace-nowrap shrink-0">{{ $t('reader.prev_slice_card_label') }}</span>
                </div>
                <div class="w-full text-sm sm:text-base font-bold text-slate-800 dark:text-slate-200 group-hover:text-brand-600 dark:group-hover:text-brand-400 truncate mt-1.5 transition-colors">
              ...
              >
                <div class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-brand-600 dark:text-brand-400 transition-colors">
                  <span class="whitespace-nowrap shrink-0">{{ $t('reader.next_slice_card_label') }}</span>
                  <ChevronRight class="w-3.5 h-3.5 transition-transform group-hover:translate-x-1 shrink-0" />
                </div>
                <div class="w-full text-sm sm:text-base font-bold text-slate-900 dark:text-white group-hover:text-brand-600 dark:group-hover:text-brand-400 truncate mt-1.5 transition-colors">
              ...
              >
                <div class="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 transition-colors">
                  <span class="whitespace-nowrap shrink-0">{{ $t('reader.completed_card_label') }}</span>
                  <CheckCircle2 class="w-3.5 h-3.5 text-emerald-500 shrink-0" />
                </div>
                <div class="w-full text-sm sm:text-base font-bold text-emerald-900 dark:text-emerald-200 group-hover:underline truncate mt-1.5 transition-colors">
