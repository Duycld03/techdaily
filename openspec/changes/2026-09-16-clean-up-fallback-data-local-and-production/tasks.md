...
- [ ] 1.1 Create standalone SQL maintenance scripts in `scripts/`:
...
- [ ] 1.2 Implement Maintenance CLI Commands in `TechDaily.Api`:
...
- [ ] 1.3 Add automated unit/integration tests for maintenance tooling:
...
- [ ] 2.1 Verify local PostgreSQL container and database connectivity:
...
- [ ] 2.2 Execute dry-run analysis on local database:
...
- [ ] 2.3 Execute transactional purge on local database:
...
- [ ] 2.4 Execute catalog re-seeding on local database:
...
- [ ] 2.5 Execute batched vector backfill on local database:
...
- [ ] 2.6 Verify local database integrity:
...
- [ ] 3.1 Establish secure SSH session to Google Cloud VPS:
...
- [ ] 3.2 Create mandatory pre-cleanup database snapshot:
...
- [ ] 3.3 Execute dry-run analysis on production database:
...
- [ ] 3.4 Execute transactional purge on production database:
...
- [ ] 3.5 Execute catalog re-seeding and vector backfill on production:
...
- [ ] 3.6 Verify production HNSW index coverage:
...
- [ ] 4.1 Execute post-cleanup verification query across both environments:
...
- [ ] 4.2 Verify System AI Health Check endpoint:
...
- [ ] 4.3 Verify semantic search functionality (RAG):
...
- [ ] 4.4 Verify User Experience & Frontend:
...
- [ ] 4.5 Document maintenance results and archive snapshot:
